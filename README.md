...
[tar.gz](https://github.com/opis/database/archive/3.4.0.tar.gz) or the [zip](https://github.com/opis/database/archive/3.4.0.zip) archive file, extract the content of the archive and include de `autoload.php` file into your project. 

```php

require_once 'path/to/database-3.4.0/autoload.php';
