...
[tar.gz](https://github.com/opis/database/archive/3.6.9.tar.gz) or the [zip](https://github.com/opis/database/archive/3.6.9.zip) archive file, extract the content of the archive and include de `autoload.php` file into your project. 

```php

require_once 'path/to/database-3.6.9/autoload.php';
