...
class InsertFirebirdTest extends BaseClass
{
    public static function setUpBeforeClass(): void
    {
        static::$database = new Database(new Connection('firebird'));
    }

    public function testMultipleRowsUseUnionAll()
    {
        $expected = 'INSERT INTO "users" ("name", "age")'
            . ' SELECT \'foo\', 18 FROM RDB$DATABASE'
            . ' UNION ALL SELECT \'bar\', 21 FROM RDB$DATABASE';
