    ...
    public function sqlDataProvider(): iterable
    {
        return [
            [
                ...
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->is(21)->select(),
            ],
            [
                'where is not',
                'SELECT * FROM "users" WHERE "age" != 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->isNot(21)->select(),
            ],
            [
                'where is lessThan',
                'SELECT * FROM "users" WHERE "age" < 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lessThan(21)->select(),
            ],
            [
                'where is lt',
                'SELECT * FROM "users" WHERE "age" < 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lt(21)->select(),
            ],
            [
                'where is greaterThan',
                'SELECT * FROM "users" WHERE "age" > 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->greaterThan(21)->select(),
            ],
            [
                'where is gt',
                'SELECT * FROM "users" WHERE "age" > 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->gt(21)->select(),
            ],
            [
                'where is atMost',
                'SELECT * FROM "users" WHERE "age" <= 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->atMost(21)->select(),
            ],
            [
                'where is lte',
                'SELECT * FROM "users" WHERE "age" <= 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lte(21)->select(),
            ],
            [
                'where is atLeast',
                'SELECT * FROM "users" WHERE "age" >= 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->atLeast(21)->select(),
            ],
            [
                'where is gte',
                'SELECT * FROM "users" WHERE "age" >= 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->gte(21)->select(),
            ],
            [
                'where between',
                'SELECT * FROM "users" WHERE "age" BETWEEN 18 AND 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->between(18, 21)->select(),
            ],
            [
                'where not between',
                'SELECT * FROM "users" WHERE "age" NOT BETWEEN 18 AND 21',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->notBetween(18, 21)->select(),
            ],
            [
                'where in array',
                'SELECT * FROM "users" WHERE "age" IN (18, 21, 31)',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->in([18, 21, 31])->select(),
            ],
            [
                'where not in array',
                'SELECT * FROM "users" WHERE "age" NOT IN (18, 21, 31)',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->notIn([18, 21, 31])->select(),
            ],
            [
                'where in query',
                'SELECT * FROM "users" WHERE "age" IN (SELECT "name" FROM "customers")',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->in(function (SubQuery $query) {
            ...
            [
                ...
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->notIn(function (SubQuery $query) {
                    $query->from('customers')->select('name');
                })->select(),
            ],
            [
                ...
                fn(DatabaseHandler $db) => $db->from('users')->where('name')->like('%foo%')->select(),
            ],
            [
                'where not like',
                'SELECT * FROM "users" WHERE "name" NOT LIKE \'%foo%\'',
                fn(DatabaseHandler $db) => $db->from('users')->where('name')->notLike('%foo%')->select(),
            ],
            [
                'where is null',
                'SELECT * FROM "users" WHERE "name" IS NULL',
                fn(DatabaseHandler $db) => $db->from('users')->where('name')->isNull()->select(),
            ],
            [
                'where is not null',
                'SELECT * FROM "users" WHERE "name" IS NOT NULL',
                fn(DatabaseHandler $db) => $db->from('users')->where('name')->notNull()->select(),
            ],
            [
                'where and condition',
            ...
            [
                ...
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->is('foo', true)->select(),
            ],
            [
                'where is not column',
                'SELECT * FROM "users" WHERE "age" != "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->isNot('foo', true)->select(),
            ],
            [
                'where is lessThan column',
                'SELECT * FROM "users" WHERE "age" < "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lessThan('foo', true)->select(),
            ],
            [
                'where is lt column',
                'SELECT * FROM "users" WHERE "age" < "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lt('foo', true)->select(),
            ],
            [
                'where is greaterThan column',
                'SELECT * FROM "users" WHERE "age" > "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->greaterThan('foo', true)->select(),
            ],
            [
                'where is gt column',
                'SELECT * FROM "users" WHERE "age" > "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->gt('foo', true)->select(),
            ],
            [
                'where is atMost column',
                'SELECT * FROM "users" WHERE "age" <= "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->atMost('foo', true)->select(),
            ],
            [
                'where is lte column',
                'SELECT * FROM "users" WHERE "age" <= "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->lte('foo', true)->select(),
            ],
            [
                'where is atLeast column',
                'SELECT * FROM "users" WHERE "age" >= "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->atLeast('foo', true)->select(),
            ],
            [
                'where is gte column',
                'SELECT * FROM "users" WHERE "age" >= "foo"',
                fn(DatabaseHandler $db) => $db->from('users')->where('age')->gte('foo', true)->select(),
            ],
            [
                'where exists',
            ...
            [
                ...
                fn(DatabaseHandler $db) => $db->from('numbers')
                    ->where('c')
            ...
            [
                ...
                fn(DatabaseHandler $db) => $db->from('names')
